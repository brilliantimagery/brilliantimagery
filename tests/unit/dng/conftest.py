...
xmp_to_try = (XMP(xmp_data, XMP_VALUE(b'xmp:Rating', '2')),
              XMP(xmp_data, XMP_VALUE(b'crs:Saturation', '+9')),
              XMP(xmp_data, XMP_VALUE(b'crs:Exposure2012', '+0.20')),
              XMP(xmp_data, XMP_VALUE(b'crs:Shadows2012', '-24')),
              XMP(xmp_data, XMP_VALUE(b'crs:RedHue', '0')),
              XMP(xmp_data, XMP_VALUE(b'crs:CropTop', '0.050467')),
              XMP(xmp_data, XMP_VALUE(b'crs:AlreadyApplied', 'False')),
              )
...
def id_xmp_data(fixture_value):
    ...
    return f'xmp({fixture_value.attr_value_pairs.attr}, {fixture_value.attr_value_pairs.value})'
