...
.. note:: This isn't a complete implementation of the lossless JPEG standard.
   Only enough has been implemented to render the available reference files.

A lossless jpeg encoder and encoder utility. It's based on the 1992 standard T.81, 10918.1.
...
Additionally, this format is easily reshaped with :func:`numpy.reshape`.
