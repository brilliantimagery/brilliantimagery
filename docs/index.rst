...
The BrilliantImagery project aims to enable making beautiful photo
based art. It has the dual goals of allowing users to use a few relatively
simple functions to accomplish powerful tasks, and to allow the
